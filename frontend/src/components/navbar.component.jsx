    ...
    <>
      <nav className='navbar dark:bg-dark-bg transition-colors duration-300 shadow-premium dark:shadow-premium-dark z-50'>
        <Link to="/" className='flex-none w-14'>
          <img src="/logo-classic.jpg" className='w-full rounded-full border-2 border-transparent hover:border-accent transition-all duration-300' alt="BlogSphere Logo" />
        </Link>
